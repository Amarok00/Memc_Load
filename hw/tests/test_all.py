...
class TestUnits(unittest.TestCase):
    ...
    def test_parse_appinstalled_values(self):
        ...
        self.assertEqual(appsinstalled.apps, [1423, 43, 567, 3, 7, 23])
    ...
    def test_parse_appinstalled_return_none(self):
        ...
        for err_line in err_lines:
            with self.subTest(err_line=err_line):
                self.assertIsNone(parse_appsinstalled(err_line.strip()))
    ...
    def test_insert_appinstalled_real(self):
        ...
        result = insert_appsinstalled(memc_mock, appsinstalled, dry_run=False)
